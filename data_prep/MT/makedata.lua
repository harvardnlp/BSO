-- A slightly modified version of https://github.com/facebookresearch/MIXER/blob/master/makedata.lua , which outputs text rather than torch Tensors.
...
local train_targets, train_sources = tok.mytokenize(config_data, 'train',
                                                  target_dict, source_dict,
                                                  opt.shuff)
print('tokenizing valid...')
local valid_targets, valid_sources = tok.mytokenize(config_data, 'valid',
                                                  target_dict, source_dict,
                                                  false)
print('tokenizing test...')
local test_targets, test_sources   = tok.mytokenize(config_data, 'test',
                                                  target_dict, source_dict,
                                                  false)
